...
For a complete visual guide on setting up and using Job Assistant, watch our tutorial video: [Job Assistant Setup Tutorial](https://www.youtube.com/watch?v=YOUR_VIDEO_ID)

## Technical Stack

- **Frontend**: Next.js, Tanstack Query, Hero UI
- **Backend**: Hono
...
- **Application won't start**: Make sure you've created the `.env` file and run the database setup
